          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-0">
            ...
            >
              <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between bg-slate-50 shrink-0">
                <h2 className="text-xl font-bold text-slate-800 tracking-tight">Detalhes do Documento</h2>
                  ...
                  <div className="bg-white rounded-xl p-5 border border-slate-200 shadow-sm">
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <p className="w-full text-sm font-medium text-slate-800 bg-slate-50 px-3 py-1.5 rounded-lg border border-slate-100">{viewItem.title}</p>
                      </div>
                      <div>
